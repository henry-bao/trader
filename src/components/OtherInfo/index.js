...
class OtherInfo extends Component {
  ...
  componentWillReceiveProps(props) {
    if (JSON.stringify(this.props) !== JSON.stringify(props)) {
      ...
      if (
        JSON.stringify(newAddress) !== JSON.stringify(this.props.data.address)
      ) {
  ...
  handleLFSubmit(event) {
    ...
    this.props.updateProfileState(
      { localAddress, state, city, landmark, country, pinCode },
      "location"
    );
  ...
  getLocationData() {
    const { localAddress, city, state, landmark, country, pinCode } =
    ...
    if (this.state.locationEditing) {
      return (
        <form
          ...
          className="lIWrapper"
          key="lIWrapper"
          onSubmit={this.handleLFSubmit.bind(this)}
        >
          ...
          <input
            type="submit"
            ref={(node) => (this.submitLFBtn = node)}
            style={{ display: "none" }}
          />
        </form>
      );
      ...
      return (
        <div className="lIWrapper" key="lIWrapperText">
          <div className="inputWrapper">
            ...
            <p className={`inputData ${updatedClass}`}>
    ...
    if (this.state.contactEditing) {
      return (
        <form
          className="cIWrapper"
          key="cIWrapper"
          onSubmit={this.handleCFSubmit.bind(this)}
          name="contactForm"
        >
          <div className="inputWrapper">
          ...
          <input
            type="submit"
            ref={(node) => (this.submitCFBtn = node)}
            style={{ display: "none" }}
          />
        </form>
      );
