...
class ItemPage extends Component {
        ...
        <button
          ...
          onClick={() => {
            if (this.props.user.loggedIn) {
              ...
              this.props.actions.requestItem(
                this.props.app.key,
                this.showErrMsg.bind(this)
              );
            } else {
  ...
  getMsg() {
    if (this.state.errMsg) {
      return <p className="warningMsg">{this.state.errMsg}</p>;
    }
    return;
  }
    ...
    return (
      <div className="itemPageWrapper">
        ...
        <div className="itemInfoWrapper">
          ...
          <p className="description">{data.itemDescription}</p>
